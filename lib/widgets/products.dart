...
// مهدي حسام اسعد: Defined the Product model and handled product data.
class Product {
  final String name;
...
class _ProductListingWidgetState extends State<ProductListingWidget> {
  // نوارة حسن: Added product list and cart functionalities.
  final List<Product> products = [
    Product(
        name: "Product 1",
        imageUrl: "assets/pexels-madebymath-90946.jpg",
        price: 19.99),
    Product(
        name: "Product 2",
  ...
  Widget build(BuildContext context) {
    // علي زاهر: Created the UI layout for the product grid.
